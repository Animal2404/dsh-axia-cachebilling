...
// src/prices.ts
var PRICE_CATALOG_URL = "https://raw.githubusercontent.com/Animal2404/dsh-meow-cachebilling/main/price-catalog.json";
...
function BillingCard(props) {
  ...
  const editor = draft === null ? null : el(
    ...
    el(
      ...
      prices.catalog !== null ? el("span", { className: "meowcb_set_hint" }, `目录更新于 ${prices.catalog.updatedAt}`) : null
    ),
